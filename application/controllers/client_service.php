...
class Client_service extends BaseController {
	...
	public function request_list() {
		...
		$data['content']  = 'client_service/request_service_list';
	...
	public function add($id) {
		$data['title']    = 'Request Service | ' . APP_NAME;
		$data['content']  = 'client_service/add_edit';
		$data['js']      = array(base_url() . 'assets/js/bootstrap-datepicker.js',
								base_url() . 'assets/js/client_service.js',
...
/* Location: ./application/controllers/client_service.php */
